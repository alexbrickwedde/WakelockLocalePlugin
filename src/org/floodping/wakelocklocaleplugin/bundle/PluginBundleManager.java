...
package org.floodping.wakelocklocaleplugin.bundle;
...
public final class PluginBundleManager
{
     ...
     */
    public static final String BUNDLE_EXTRA_INT_STARTSTOP = "XYZ";
     ...
     */
    public static final String BUNDLE_EXTRA_INT_VERSION_CODE = "org.floodping.wakelocklocaleplugin.extra.INT_VERSION_CODE"; //$NON-NLS-1$
    ...
    public static boolean isBundleValid(final Bundle bundle)
    {
         ...
         */
        if (!bundle.containsKey(BUNDLE_EXTRA_INT_STARTSTOP))
        {
            if (Constants.IS_LOGGABLE)
            {
                Log.e(Constants.LOG_TAG, String.format("bundle must contain extra %d", BUNDLE_EXTRA_INT_STARTSTOP)); //$NON-NLS-1$
            }
            return false;
        }
         ...
         */
//        if (bundle.getInt(BUNDLE_EXTRA_INT_STARTSTOP))
//        {
//            if (Constants.IS_LOGGABLE)
//            {
